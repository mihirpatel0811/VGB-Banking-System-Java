...
<head>
    ...
    <style>
        ...
        .product-card::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(110deg, rgba(255, 255, 255, 0.15) 15%, rgba(255, 255, 255, 0.03) 25%, transparent 60%);
            pointer-events: none;
        }
                        ...
                        <div>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 15px;">
                                ...
                                <div style="display: flex; justify-content: space-between; font-size: 0.8rem; border-bottom: 1px dashed rgba(212,175,55,0.2); padding-bottom: 4px;">
                                    ...
                                    <strong style="color: var(--gray-800);">Grace Period: Up to 45 Days</strong>
                                </div>
                            </div>
                        </div>
                        <div>
