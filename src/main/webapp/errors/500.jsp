...
<head>
    ...
    <title>VGB | Server Error (500)</title>
...
<body class="bank-home-page" style="min-height: 100vh; display: flex; align-items: center; justify-content: center; position: relative;">
    ...
    <div style="text-align: center; max-width: 500px; padding: 40px 20px; background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(20px); border: 1px solid rgba(99, 102, 241, 0.2); border-radius: var(--radius-xl); box-shadow: var(--shadow-2xl); position: relative; z-index: 10;">
        <i class="bx bx-shield-x" style="font-size: 5rem; color: #ef4444; margin-bottom: 20px;"></i>
        <h1 style="font-size: 4rem; font-weight: 800; color: var(--gray-900); line-height: 1; margin-bottom: 10px;">500</h1>
        <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--gray-800); margin-bottom: 15px;">Internal Server Error</h2>
        <p style="color: var(--gray-500); font-size: 0.95rem; line-height: 1.6; margin-bottom: 30px;">Our database engine encountered an unexpected error trying to write or verify transaction logs. Please try again.</p>
