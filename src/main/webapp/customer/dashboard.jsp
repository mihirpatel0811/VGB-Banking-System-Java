                    ...
                    <c:when test="${not empty customer}">
                        <c:choose>
                            <c:when test="${not empty customer.avatarPath}">
                                <img src="${pageContext.request.contextPath}${customer.avatarPath}" alt="Customer Profile Avatar" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/assest/images/default-avatar.jpg';" style="width: 36px; height: 36px; border-radius: 50%; object-fit: cover; border: 2px solid var(--primary-500); box-shadow: 0 0 10px rgba(99, 102, 241, 0.15);">
                            </c:when>
                            <c:otherwise>
                                ...
                                <div>
                                    ...
                                    <div class="vgb-luxury-balance-wrapper">
                                        ...
                                        <button type="button" onclick="toggleBalanceVisibility()" class="vgb-luxury-toggle-btn" id="eyeBalanceBtn" title="Show/Hide Balance">
                                            <i class="bx bx-hide" id="eyeBalanceIcon"></i>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="vgb-luxury-account-wrapper">
                                        <span class="vgb-luxury-account-number" id="cardNumberDisplay" 
                                            ...
                                            ${not empty activeAccount ? '••••  ••••  ••••  '.concat(activeAccount.accountNumber.substring(activeAccount.accountNumber.length() - 4)) : '••••  ••••  ••••  0000'}
                                        </span>
                                ...
                                <div class="vgb-luxury-profile-wrapper">
                                    <c:choose>
                                        <c:when test="${not empty customer && not empty customer.avatarPath}">
                                            <img src="${pageContext.request.contextPath}${customer.avatarPath}" alt="Customer Profile Avatar" class="vgb-luxury-profile-img" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/assest/images/default-avatar.jpg';">
                                        </c:when>
                                        <c:otherwise>
                                            <img src="${pageContext.request.contextPath}/assest/images/default-avatar.jpg" alt="Customer Profile Avatar" class="vgb-luxury-profile-img" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/assest/images/logo.png';" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover; border: 2px solid white;">
                                        </c:otherwise>
                                    </c:choose>
                                </div>
