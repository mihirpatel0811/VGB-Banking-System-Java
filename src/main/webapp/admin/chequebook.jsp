...
<body class="bank-home-page">
                    ...
                    <div class="cheque-visualizer-container" style="padding: 40px 20px; min-height: 330px; background: linear-gradient(135deg, rgba(99, 102, 241, 0.04) 0%, rgba(6, 182, 212, 0.04) 100%); border: 1px solid rgba(99, 102, 241, 0.15); border-radius: var(--radius-lg); position: relative; box-shadow: inset 0 2px 8px rgba(99, 102, 241, 0.05); display: flex; align-items: center; justify-content: center;">
                        <div style="position: absolute; top: 12px; left: 15px; display: flex; gap: 8px; align-items: center; pointer-events: none;">
                            <span style="background: rgba(99, 102, 241, 0.1); color: var(--primary-500); font-size: 0.7rem; font-weight: 700; padding: 3px 8px; border-radius: var(--radius-sm); display: flex; align-items: center; gap: 4px;">
                                <i class="bx bx-expand-alt" style="font-size: 0.8rem;"></i> Flat Sandbox
                            </span>
                        </div>
                        <div class="cheque-leaf-container-wrapper" id="demoChequebookWrapper">
                            <div class="cheque-leaf-wrapper" id="demoChequeLeafFlipWrapper" onclick="toggleDemoChequeLeafFlip(event)">
                                <!-- Cheque Leaf Front -->
                                <div class="cheque-leaf-front" id="demoChequeLeaf3D">
                        ...
                        <div class="click-hint" id="demoChequeHint" style="position: absolute; bottom: 12px; right: 15px; font-size: 0.65rem; color: var(--primary-500); display: flex; align-items: center; gap: 4px; font-weight: 500; animation: pulseHint 2s infinite; pointer-events: none;"><i class="bx bx-pointer"></i> Click Cheque to Flip</div>
                    </div>
    ...
    <script>
        function openInspectModal(requestId, customerName, accountNumber, leavesCount, charges, requestedDateStr, status) {
            ...
            // Reset inspector leaf to unflipped when opening modal
        ...
        // Add outside click close listener
        ...
        function syncDemoCheque() {
            ...
            if (cheque) {
                if (theme === 'sky') {
                    ...
                    cheque.style.backgroundImage = 'radial-gradient(circle at 10% 90%, rgba(10, 185, 129, 0.05) 0%, transparent 60%), radial-gradient(circle at 90% 10%, rgba(4, 120, 87, 0.04) 0%, transparent 50%), linear-gradient(to right, #a7f3d0, #d1fae5)';
