<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
            ...
            <aside class="sidebar no-print">
                <div class="sidebar-menu">
                    ...
                    <a href="${pageContext.request.contextPath}/account?action=list"><i class="bx bx-user-check"></i>
                        Manage Accounts</a>
                    <a href="${pageContext.request.contextPath}/account/transfer" class="active"><i
                    ...
                    <a href="${pageContext.request.contextPath}/passbook?action=list"><i class="bx bx-book-open"></i>
                        Passbook Requests</a>
                ...
                <div
                    ...
                    <p style="font-size: 0.9rem; color: var(--primary-500); font-weight: 700; margin-top: 3px;">INTERNAL
                        USE ONLY</p>
                </div>
            </aside>
            ...
            <main class="main-content">
                <div class="container" style="max-width: 1200px; padding: 0;">
                    <div style="margin-bottom: 35px;">
                        <h2 style="font-size: 2rem; font-weight: 800; color: var(--gray-900);">Administrative Teller
                            Desk</h2>
                        <p style="color: var(--gray-500); font-size: 0.95rem; margin-top: 5px;">Post physical counter
                            deposits, withdrawals, or system wire routing tasks directly.</p>
                    </div>

                    <!-- Alerts -->
                    <c:if test="${not empty sessionScope.error or not empty error}">
                        <div
                            style="background: rgba(239, 68, 68, 0.1); border-left: 4px solid #ef4444; color: #b91c1c; padding: 15px; border-radius: var(--radius-md); margin-bottom: 25px; font-size: 0.9rem; display: flex; align-items: center; gap: 10px;">
                    ...
                    <c:if test="${not empty sessionScope.success or not empty success}">
                        <div
                            style="background: rgba(16, 185, 129, 0.1); border-left: 4px solid #10b981; color: #047857; padding: 15px; border-radius: var(--radius-md); margin-bottom: 25px; font-size: 0.9rem; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="counter-tabs">
                        <button type="button" class="counter-tab-btn active" id="btnTabDeposit"
                            onclick="switchCounterPane('deposit')">
                            <i class="bx bx-down-arrow-alt"></i> <span>Cash Deposit</span>
                        </button>
                        <button type="button" class="counter-tab-btn" id="btnTabWithdraw"
                            onclick="switchCounterPane('withdraw')">
                            <i class="bx bx-up-arrow-alt"></i> <span>Cash Withdrawal</span>
                        </button>
                        <button type="button" class="counter-tab-btn" id="btnTabTransfer"
                            onclick="switchCounterPane('transfer')">
                            <i class="bx bx-transfer"></i> <span>Internal Transfer</span>
                        </button>
                        <button type="button" class="counter-tab-btn" id="btnTabExternalTransfer"
                            onclick="switchCounterPane('external_transfer')">
                            <i class="bx bx-transfer-alt"></i> <span>External Transfer</span>
                        </button>
                        <button type="button" class="counter-tab-btn" id="btnTabLoanRepay"
                            onclick="switchCounterPane('loanrepay')">
                            <i class="bx bx-credit-card"></i> <span>Loan Repayment</span>
                        </button>
                        <button type="button" class="counter-tab-btn" id="btnTabHistory"
                            onclick="switchCounterPane('history')">
                        ...
                        <div class="counter-grid">
                            ...
                            <div class="glass-card">
                                ...
                                <form action="${pageContext.request.contextPath}/account?action=deposit" method="post"
                                    id="formDeposit" onsubmit="return validateDepositForm()">
                                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
                                    <input type="hidden" name="accountId" id="hidDepositAccId">
                                    <input type="hidden" name="redirectUrl" value="/account/transfer">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="search-select-wrapper" id="selectDepositAccWrapper">
                                            <input type="text" class="search-select-input" id="txtDepositAcc"
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Deposit
                                            Amount (INR)</label>
                                        <input type="number" step="0.01" min="500" name="amount" id="numDepositAmt"
                                            required placeholder="Min. ₹500"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcDepositPayout()">
                                    </div>

                                    <div class="form-group" style="margin-bottom: 25px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transaction
                                            Description</label>
                                        <input type="text" name="description" id="txtDepositDesc"
                                            value="Teller counter cash load"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;">
                                    </div>

                                    <button type="submit" class="btn btn-primary btn-submit" style="width: 100%;">Post
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <h4
                                    style="font-size: 0.95rem; font-weight: 700; color: var(--gray-700); margin-bottom: 15px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Verified Target Profile</h4>

                                <div class="verified-preview-card" id="cardDepositPreview">
                                    <div class="verified-badge"><i class="bx bx-shield-quarter"></i> Awaiting Account
                                        Selection</div>
                                    <p
                                        style="color: var(--gray-400); font-size: 0.85rem; text-align: center; padding: 30px 0;">
                                        Please search and choose a target account in the left panel to verify details.
                                    </p>
                                </div>
                        ...
                        <div class="counter-grid">
                            ...
                            <div class="glass-card">
                                ...
                                <form action="${pageContext.request.contextPath}/account?action=withdraw" method="post"
                                    id="formWithdraw" onsubmit="return validateWithdrawForm()">
                                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="search-select-wrapper" id="selectWithdrawAccWrapper">
                                            <input type="text" class="search-select-input" id="txtWithdrawAcc"
                                                placeholder="Type customer name or account number..."
                                                autocomplete="off">
                                            <i class="bx bx-search search-select-icon"></i>
                                            <i class="bx bx-chevron-down search-select-arrow"></i>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Payment
                                            Mode</label>
                                        <div style="display: flex; gap: 20px; align-items: center; margin-top: 5px;">
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cash" checked
                                                    onchange="togglePaymentMode('withdraw', this.value)"
                                                    style="accent-color: var(--primary-500);"> Cash Withdrawal
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cheque"
                                                    onchange="togglePaymentMode('withdraw', this.value)"
                                                    style="accent-color: var(--primary-500);"> Checkbook Withdrawal
                                            </label>
                                        </div>
                                    </div>

                                    <div class="form-group cheque-only-withdraw"
                                        style="margin-bottom: 20px; display: none;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Book Number</label>
                                        <select name="chequeBookNumber" id="selWithdrawChequeBook"
                                            class="search-select-input" style="width: 100%; height: auto;"
                                            onchange="loadCheques('withdraw', this.value)">
                                    ...
                                    <div class="form-group cheque-only-withdraw"
                                        ...
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Number</label>
                                        <select name="chequeNumber" id="selWithdrawChequeNo" class="search-select-input"
                                            style="width: 100%; height: auto;" onchange="recalcWithdrawPayout()">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Withdrawal
                                            Amount (INR)</label>
                                        <input type="number" step="0.01" min="100" name="amount" id="numWithdrawAmt"
                                            required placeholder="Max. ₹3,00,000"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcWithdrawPayout()">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 25px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transaction
                                            Description</label>
                                        <input type="text" name="description" id="txtWithdrawDesc"
                                            value="Teller counter cash payout"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;">
                                    </div>

                                    <button type="submit" class="btn btn-primary btn-submit" id="btnSubmitWithdraw"
                                        style="width: 100%;">Post Withdrawal Amount</button>
                                </form>
                            </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                ...
                                <div class="verified-preview-card" id="cardWithdrawPreview">
                                    ...
                                    <p
                                        style="color: var(--gray-400); font-size: 0.85rem; text-align: center; padding: 30px 0;">
                                        Please search and choose a source account in the left panel to verify details.
                                    </p>
                                </div>
                    ...
                    <div class="counter-pane" id="paneTransfer">
                        <div class="counter-grid">
                            ...
                            <div class="glass-card">
                                ...
                                <form action="${pageContext.request.contextPath}/account?action=transfer" method="post"
                                    id="formTransfer" onsubmit="return validateTransferForm()">
                                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Select
                                            Source Account (From)</label>
                                        <div class="search-select-wrapper" id="selectTransferFromWrapper">
                                            <input type="text" class="search-select-input" id="txtTransferFrom"
                                                placeholder="Type source customer name or account number..."
                                                autocomplete="off">
                                            <i class="bx bx-search search-select-icon"></i>
                                            <i class="bx bx-chevron-down search-select-arrow"></i>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div style="display: flex; gap: 20px; align-items: center; margin-top: 5px;">
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cash" checked
                                                    onchange="togglePaymentMode('transfer', this.value)"
                                                    style="accent-color: var(--primary-500);"> Cash Transfer
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cheque"
                                                    onchange="togglePaymentMode('transfer', this.value)"
                                                    style="accent-color: var(--primary-500);"> Checkbook Transfer
                                            </label>
                                        </div>
                                    </div>

                                    <div class="form-group cheque-only-transfer"
                                        style="margin-bottom: 20px; display: none;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Book Number</label>
                                        <select name="chequeBookNumber" id="selTransferChequeBook"
                                            class="search-select-input" style="width: 100%; height: auto;"
                                            onchange="loadCheques('transfer', this.value)">
                                            <option value="">-- Select Active Cheque Book --</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group cheque-only-transfer"
                                        ...
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Number</label>
                                        <select name="chequeNumber" id="selTransferChequeNo" class="search-select-input"
                                            style="width: 100%; height: auto;" onchange="recalcTransferPayout()">
                                            <option value="">-- Select Unused Cheque Number --</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Select
                                            Target Account (To)</label>
                                        <div class="search-select-wrapper" id="selectTransferToWrapper">
                                            <input type="text" class="search-select-input" id="txtTransferTo"
                                                placeholder="Type target customer name or account number..."
                                                autocomplete="off">
                                            <i class="bx bx-search search-select-icon"></i>
                                            <i class="bx bx-chevron-down search-select-arrow"></i>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transfer
                                            Amount (INR)</label>
                                        <input type="number" step="0.01" min="1" name="amount" id="numTransferAmt"
                                            required placeholder="Max. ₹3,50,000"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcTransferPayout()">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 25px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transaction
                                            Description</label>
                                        <input type="text" name="description" id="txtTransferDesc"
                                            value="Teller counter bank transfer"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;">
                                    </div>

                                    <button type="submit" class="btn btn-primary btn-submit" id="btnSubmitTransfer"
                                        style="width: 100%;">Post Funds Transfer</button>
                                </form>
                            </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <h4
                                    style="font-size: 0.95rem; font-weight: 700; color: var(--gray-700); margin-bottom: 15px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Verified Wire Route</h4>

                                <!-- Stacked panels representing wire flow -->
                                <div id="transferRouteContainer">
                                    <div class="verified-preview-card" id="cardTransferSourcePreview"
                                        style="margin-bottom: 10px;">
                                        <div class="verified-badge"
                                            style="background: rgba(99,102,241,0.08); color: var(--primary-500);"><i
                                                class="bx bx-shield-quarter"></i> Source Awaiting</div>
                                        <p
                                            style="color: var(--gray-400); font-size: 0.82rem; text-align: center; padding: 10px 0;">
                                    ...
                                    <div class="verified-preview-card" id="cardTransferTargetPreview">
                                        <div class="verified-badge"
                                            style="background: rgba(99,102,241,0.08); color: var(--primary-500);"><i
                                                class="bx bx-shield-quarter"></i> Target Awaiting</div>
                                        <p
                                            style="color: var(--gray-400); font-size: 0.82rem; text-align: center; padding: 10px 0;">
                                            Select target account.</p>
                                    </div>
                                </div>
                    ...
                    <div class="counter-pane" id="paneExternalTransfer">
                        <div class="counter-grid">
                            ...
                            <div class="glass-card">
                                ...
                                <form action="${pageContext.request.contextPath}/account?action=transfer" method="post"
                                    id="formExternalTransfer" onsubmit="return validateExternalTransferForm()">
                                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="search-select-wrapper" id="selectExtTransferFromWrapper">
                                            <input type="text" class="search-select-input" id="txtExtTransferFrom"
                                                placeholder="Type source customer name or account number..."
                                                autocomplete="off">
                                            <i class="bx bx-search search-select-icon"></i>
                                            <i class="bx bx-chevron-down search-select-arrow"></i>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div style="display: flex; gap: 20px; align-items: center; margin-top: 5px;">
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cash" checked
                                                    onchange="togglePaymentMode('ext_transfer', this.value)"
                                                    style="accent-color: var(--primary-500);"> Cash Wire
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.9rem; color: var(--gray-800);">
                                                <input type="radio" name="paymentMode" value="cheque"
                                                    onchange="togglePaymentMode('ext_transfer', this.value)"
                                                    style="accent-color: var(--primary-500);"> Checkbook Wire
                                            </label>
                                        </div>
                                    </div>

                                    <div class="form-group cheque-only-ext_transfer"
                                        style="margin-bottom: 20px; display: none;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Book Number</label>
                                        <select name="chequeBookNumber" id="selExtTransferChequeBook"
                                            class="search-select-input" style="width: 100%; height: auto;"
                                            onchange="loadCheques('ext_transfer', this.value)">
                                            <option value="">-- Select Active Cheque Book --</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group cheque-only-ext_transfer"
                                        ...
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Cheque
                                            Number</label>
                                        <select name="chequeNumber" id="selExtTransferChequeNo"
                                            class="search-select-input" style="width: 100%; height: auto;"
                                            onchange="recalcExternalTransferPayout()">
                                            <option value="">-- Select Unused Cheque Number --</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Beneficiary
                                            Name</label>
                                        <input type="text" name="beneficiaryName" id="txtExtBeneficiaryName" required
                                            placeholder="Enter holder's name"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcExternalTransferPayout()">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <input type="text" name="beneficiaryAccountNumber" id="txtExtBeneficiaryAcc"
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">IFSC
                                            Code</label>
                                        <input type="text" name="ifscCode" id="txtExtBeneficiaryIfsc" required
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Bank
                                            Name</label>
                                        <input type="text" name="bankName" id="txtExtBeneficiaryBank" required
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Branch
                                            Name (Optional)</label>
                                        <input type="text" name="branchName" id="txtExtBeneficiaryBranch"
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transfer
                                            Amount (INR)</label>
                                        <input type="number" step="0.01" min="1" name="amount" id="numExtTransferAmt"
                                            required placeholder="Max. ₹3,50,000"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcExternalTransferPayout()">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 25px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transaction
                                            Description</label>
                                        <input type="text" name="description" id="txtExtTransferDesc"
                                            value="Teller counter external bank transfer"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;">
                                    </div>

                                    <button type="submit" class="btn btn-primary btn-submit" id="btnSubmitExtTransfer"
                                        style="width: 100%;">Post External Transfer</button>
                                </form>
                            </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                ...
                                <div id="extTransferRouteContainer">
                                    <div class="verified-preview-card" id="cardExtTransferSourcePreview"
                                        style="margin-bottom: 10px;">
                                        <div class="verified-badge"
                                            style="background: rgba(99,102,241,0.08); color: var(--primary-500);"><i
                                                class="bx bx-shield-quarter"></i> Source Awaiting</div>
                                    ...
                                    <div class="verified-preview-card" id="cardExtTransferTargetPreview">
                                        <div class="verified-badge"
                                            style="background: rgba(245, 158, 11, 0.08); color: #d97706;"><i
                                                class="bx bx-shield-quarter"></i> Target Beneficiary Details</div>
                                        <p
                                            style="color: var(--gray-400); font-size: 0.82rem; text-align: center; padding: 10px 0;">
                                            Enter beneficiary details left.</p>
                                    </div>
                                </div>
                        ...
                        <div class="counter-grid">
                            ...
                            <div class="glass-card">
                                ...
                                <form action="${pageContext.request.contextPath}/loan?action=repayment" method="post"
                                    id="formLoanRepay" onsubmit="return validateLoanRepayForm()">
                                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Select
                                            Active Loan Profile</label>
                                        <div class="search-select-wrapper" id="selectRepayLoanWrapper">
                                            <input type="text" class="search-select-input" id="txtRepayLoan"
                                                placeholder="Type customer name, loan ID or type..." autocomplete="off">
                                            <i class="bx bx-search search-select-icon"></i>
                                            <i class="bx bx-chevron-down search-select-arrow"></i>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <select name="accountId" id="repayAccount" required
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); background: white; outline: none; font-size: 0.9rem;"
                                            onchange="recalcLoanRepayPayout()">
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        <label
                                            ...
                                            Amount (INR)</label>
                                        <input type="number" step="0.01" min="1" name="amount" id="numRepayAmt" required
                                            placeholder="E.g., 5000"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;"
                                            oninput="recalcLoanRepayPayout()">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 25px;">
                                        <label
                                            style="display: block; font-size: 0.85rem; font-weight: 500; color: var(--gray-700); margin-bottom: 8px;">Transaction
                                            Description</label>
                                        <input type="text" name="description" id="txtRepayDesc"
                                            value="Teller counter loan repayment"
                                            style="width: 100%; padding: 12px 15px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem;">
                                    </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <h4
                                    style="font-size: 0.95rem; font-weight: 700; color: var(--gray-700); margin-bottom: 15px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Verified Loan Ledger</h4>

                                <div class="verified-preview-card" id="cardLoanRepayPreview">
                                    <div class="verified-badge"><i class="bx bx-shield-quarter"></i> Awaiting Loan
                                        Selection</div>
                                    <p
                                        style="color: var(--gray-400); font-size: 0.85rem; text-align: center; padding: 30px 0;">
                                        Please search and select a loan portfolio in the left panel to verify details.
                                    </p>
                                </div>
                    ...
                    <div class="counter-pane" id="paneHistory">
                        <div class="glass-card" style="margin-bottom: 25px; padding: 25px;">
                            <div class="print-hidden"
                                style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(99, 102, 241, 0.1); padding-bottom: 15px; margin-bottom: 20px;">
                                <h3
                                    style="font-size: 1.25rem; font-weight: 700; color: var(--gray-800); margin: 0; display: flex; align-items: center; gap: 10px;">
                                    <i class="bx bx-history" style="color: var(--primary-500);"></i> Core Transaction
                                    Ledger Log
                                </h3>
                                <div style="display: flex; gap: 10px;">
                                    <button type="button" class="btn btn-secondary" onclick="exportToCSV()"
                                        style="display: flex; align-items: center; gap: 6px; padding: 8px 15px; font-size: 0.85rem; border: 1.5px solid var(--gray-300); background: white; color: var(--gray-700); cursor: pointer; border-radius: var(--radius-md);">
                                        <i class="bx bx-file" style="font-size: 1.1rem;"></i> Export Excel (CSV)
                                    </button>
                                    <button type="button" class="btn btn-primary" onclick="window.print()"
                                        style="display: flex; align-items: center; gap: 6px; padding: 8px 15px; font-size: 0.85rem; background: var(--primary-500); color: white; cursor: pointer; border: none; border-radius: var(--radius-md);">
                            ...
                            <div class="print-hidden"
                                style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; margin-bottom: 20px; background: #f8fafc; padding: 15px; border-radius: var(--radius-md); border: 1px solid var(--gray-200);">
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Customer
                                        Name</label>
                                    <input type="text" id="filterCustName" placeholder="Search name..."
                                        oninput="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                </div>
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Account
                                        Number</label>
                                    <input type="text" id="filterAccNum" placeholder="Search account..."
                                        oninput="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                </div>
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Type</label>
                                    <select id="filterType" onchange="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                ...
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Status</label>
                                    <select id="filterStatus" onchange="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                ...
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Date
                                        Filter</label>
                                    <select id="filterDate"
                                        onchange="toggleCustomDateFields(this.value); triggerHistoryLoad();"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                            ...
                            <!-- Custom Date Fields -->
                            <div id="customDateContainer" class="print-hidden"
                                style="display: none; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px; background: #f1f5f9; padding: 12px; border-radius: var(--radius-md); border: 1px solid var(--gray-200);">
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">Start
                                        Date</label>
                                    <input type="date" id="filterStartDate" onchange="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                </div>
                                <div class="form-group" style="margin: 0;">
                                    <label
                                        style="display: block; font-size: 0.78rem; font-weight: 600; color: var(--gray-600); margin-bottom: 6px;">End
                                        Date</label>
                                    <input type="date" id="filterEndDate" onchange="triggerHistoryLoad()"
                                        style="width: 100%; padding: 8px 12px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-sm); outline: none; font-size: 0.85rem; background: white;">
                                </div>
                            </div>
                            ...
                            <div class="form-group print-hidden" style="margin-bottom: 20px;">
                                <div style="position: relative;">
                                    <input type="text" id="filterQueryText"
                                        placeholder="Search by Transaction ID or Reference Number (e.g., TXN...)"
                                        oninput="triggerHistoryLoad()"
                                        style="width: 100%; padding: 12px 15px 12px 40px; border: 1.5px solid var(--gray-200); border-radius: var(--radius-md); outline: none; font-size: 0.9rem; background: white; box-shadow: var(--shadow-sm);">
                                    <i class="bx bx-search"
                                        style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); font-size: 1.2rem; color: var(--gray-400);"></i>
                                </div>
                            </div>

                            <!-- Ledger Table -->
                            <div
                                style="overflow-x: auto; border: 1px solid var(--gray-200); border-radius: var(--radius-md);">
                                <table
                                    style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.85rem;"
                                    id="tblHistoryLedger">
                                    <thead>
                                        <tr
                                            style="background: var(--gray-50); border-bottom: 1.5px solid var(--gray-200); color: var(--gray-600); font-weight: 600; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 0.5px;">
                                    ...
                                    <tbody id="tbodyHistoryLedger">
                                        <tr>
                                            <td colspan="8"
                                                style="padding: 40px; text-align: center; color: var(--gray-400);">
                                                <i class="bx bx-loader-alt bx-spin"
                                                    style="font-size: 2rem; margin-bottom: 10px; color: var(--primary-500);"></i>
            ...
            <footer class="footer"
                ...
                <div class="container" style="text-align: center; max-width: 1200px; padding: 0;">
                    <p style="font-size: 0.85rem; color: var(--gray-500);">&copy; <span data-current-year>2026</span>
                        Vertex Galaxy Bank. Internal administrative access.</p>
                </div>
            </footer>
        ...
        <c:out value="${accountsJson}" escapeXml="false" />
    </script>
        ...
        <c:out value="${loansJson}" escapeXml="false" />
    </script>
            ...
            <script>
                ...
                let allLoans = [];
                try {
                    allAccounts = JSON.parse(document.getElementById('accounts-data').textContent || '[]');
                    allAccounts.forEach(acc => {
                        acc.balance = parseFloat(acc.balance) || 0.0;
                    });
                } catch (e) {
                    console.error("Failed to parse accounts JSON data:", e);
                }
                try {
                    allLoans = JSON.parse(document.getElementById('loans-data').textContent || '[]');
                    allLoans.forEach(loan => {
                        loan.remainingBalance = parseFloat(loan.remainingBalance) || 0.0;
                        loan.principalAmount = parseFloat(loan.principalAmount) || 0.0;
                    });
                } catch (e) {
                    console.error("Failed to parse loans JSON data:", e);
                }
            </script>
            <script>
            ...
            <div id="receiptModal"
                style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 10000; align-items: center; justify-content: center; padding: 20px;"
                class="print-hidden">
                <div
                    style="background: white; width: 100%; max-width: 500px; border-radius: var(--radius-lg); box-shadow: var(--shadow-lg); overflow: hidden; display: flex; flex-direction: column;">
                    <!-- Header -->
                    <div
                        style="background: var(--primary-500); color: white; padding: 20px; display: flex; justify-content: space-between; align-items: center;">
                        <h4 style="margin: 0; font-size: 1.1rem; font-weight: 600;">Transaction Receipt</h4>
                        <button onclick="closeReceiptModal()"
                            style="background: none; border: none; color: white; font-size: 1.5rem; cursor: pointer; display: flex; align-items: center;"><i
                                class="bx bx-x"></i></button>
                    </div>

                    <!-- Receipt Printable Content -->
                    <div id="receiptPrintArea"
                        style="padding: 25px; overflow-y: auto; flex-grow: 1; font-family: 'Outfit', sans-serif;">
                        <div
                            style="text-align: center; margin-bottom: 20px; border-bottom: 2px dashed var(--gray-200); padding-bottom: 15px;">
                            <h3
                                style="margin: 0 0 5px 0; font-size: 1.5rem; font-weight: 800; color: var(--primary-600); letter-spacing: 0.5px;">
                                VERTEX GALAXY BANK</h3>
                            <p style="margin: 0; font-size: 0.8rem; color: var(--gray-500); text-transform: uppercase;">
                                Counter Service Branch</p>
                        </div>

                        <table
                            style="width: 100%; font-size: 0.88rem; border-collapse: collapse; color: var(--gray-800);">
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500); width: 40%;">
                                    Transaction ID</td>
                                <td style="padding: 10px 0; text-align: right; font-weight: 700;" id="recTxnId">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Reference Number
                                </td>
                                <td style="padding: 10px 0; text-align: right; font-weight: 700; font-family: monospace;"
                                    id="recRefNum">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Date &amp; Time
                                </td>
                                <td style="padding: 10px 0; text-align: right;" id="recDateTime">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Transaction Type
                                </td>
                                <td style="padding: 10px 0; text-align: right; text-transform: capitalize; font-weight: 600;"
                                    id="recType">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Payment Mode</td>
                                <td style="padding: 10px 0; text-align: right; text-transform: capitalize;"
                                    id="recMode">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Sender Account
                                </td>
                                <td style="padding: 10px 0; text-align: right; font-weight: 600;" id="recSender">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Receiver Account
                                </td>
                                <td style="padding: 10px 0; text-align: right; font-weight: 600;" id="recReceiver">-
                                </td>
                            </tr>
                            <!-- External Beneficiary Row Group -->
                            <tr id="rowRecBeneficiary" style="border-bottom: 1px solid var(--gray-100); display: none;">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Beneficiary
                                    Details</td>
                                <td style="padding: 10px 0; text-align: right; font-size: 0.8rem; line-height: 1.4;"
                                    id="recBeneficiaryVal">-</td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--gray-100);">
                                <td style="padding: 10px 0; font-weight: 600; color: var(--gray-500);">Performed By (ID)
                                </td>
                            ...
                            <tr>
                                <td
                                    style="padding: 15px 0 10px 0; font-weight: 700; font-size: 1.1rem; color: var(--gray-800);">
                                    Amount Paid</td>
                                <td style="padding: 15px 0 10px 0; text-align: right; font-weight: 800; font-size: 1.3rem; color: var(--primary-600);"
                                    id="recAmount">-</td>
                            </tr>
                        </table>

                        <div
                            style="margin-top: 25px; text-align: center; font-size: 0.75rem; color: var(--gray-400); border-top: 1px dashed var(--gray-200); padding-top: 15px;">
                            Thank you for banking with Vertex Galaxy Bank. This is a computer-generated transaction
                            receipt.
                        </div>
                    </div>
                    ...
                    <!-- Footer Actions -->
                    <div
                        style="background: var(--gray-50); padding: 15px; display: flex; gap: 10px; justify-content: flex-end; border-top: 1px solid var(--gray-200);">
                        <button type="button" onclick="closeReceiptModal()"
                            style="border: 1.5px solid var(--gray-300); background: white; color: var(--gray-700); padding: 8px 16px; border-radius: var(--radius-md); font-size: 0.85rem; font-weight: 500; cursor: pointer;">Close</button>
                        <button type="button" onclick="printReceipt()"
                            style="background: var(--primary-500); border: none; color: white; padding: 8px 16px; border-radius: var(--radius-md); font-size: 0.85rem; font-weight: 500; cursor: pointer; display: flex; align-items: center; gap: 6px;">
